...
urlpatterns = [
    ...
    path('activities_database/', EventListView.as_view(), name='admin_activities_database'),
    path('activities_database/add', views.activity_add, name='admin_activities_add'),
    path('activities_database/<int:id>', views.activity_update, name='admin_activities_edit'),
    path('activities_database/<int:id>/delete', views.activity_delete, name='admin_activities_delete'),
    ...
    path('useraccounts/', UserListView.as_view(), name='admin_userAccounts_database'),
    path('useraccounts/add', views.user_add, name='admin_userAccounts_add'),
    path('useraccounts/<int:id>', views.user_update, name='admin_userAccounts_edit'),
    path('useraccounts/<int:id>/delete', views.user_delete, name='admin_userAccounts_delete'),
    path('databasegallery/', GalleryListView.as_view(), name='admin_gallery_database'),
    path('databasegallery/add', views.gallery_add, name='admin_gallery_add'),
    path('databasegallery/<int:id>', views.gallery_update, name='admin_gallery_edit'),
    path('databasegallery/<int:id>/delete', views.gallery_delete, name='admin_gallery_delete'),
