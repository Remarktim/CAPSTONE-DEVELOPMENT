...
urlpatterns = [
    ...
    path("confirm_accept/<int:report_id>/",
         views.confirm_accept, name="confirm-accept"),
    path("accept-incident/<int:report_id>/",
         views.accept_incident, name="accept-incident"),
    path("confirm_cancel/<int:report_id>/",
         views.confirm_cancel, name="confirm-cancel"),
    path("cancel-incident/<int:report_id>/",
         views.cancel_incident, name="cancel-incident"),
